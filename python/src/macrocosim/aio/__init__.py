"""The async-native core of the macrocosim client (v2).
...
Typical use::
    ...
    load = mc.meter(id=5, power=Power.zero())  # ... build the topology
    async with mc.aio.launch(mg) as site:      # binds the builders
